      ...
      {createPortal(
        ...
        >
          ...
          <div
            ...
            aria-modal="true"
            aria-label="Betslip"
            className="absolute inset-x-0 bottom-0 z-60 flex h-[80vh] max-h-[80vh] flex-col overflow-hidden rounded-t-sm bg-(--sb-bg-card) lg:hidden"
            style={{
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto">
          ...
          <div className="mb-3 flex items-center gap-2">
            ...
            <button
              ...
              className="h-11 shrink-0 cursor-pointer rounded-2xl border-0 bg-(--sb-accent-fill) px-4 text-xs font-extrabold text-[#000000] shadow-[0_8px_20px_-6px_rgba(245,197,24,0.4)] transition-all hover:bg-(--sb-accent-fill-hover) disabled:cursor-not-allowed disabled:opacity-40"
            >
              MAX
            </button>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="h-11 min-w-0 flex-1 cursor-pointer rounded-sm border-0 bg-(--sb-accent-fill) text-sm font-bold uppercase tracking-wide text-(--sb-accent-text-on-dark) hover:bg-(--sb-accent-fill-hover) disabled:pointer-events-none disabled:opacity-50"
            >
