...
function DesktopUserSidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      >
        <div className="pointer-events-none absolute -right-8 -top-12 h-28 w-40 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(245,197,24,0.18),transparent_70%)] blur-2xl" />
              ...
              return (
                ...
                >
                  {item.icon ? (
                    ...
                    <span className="h-8 w-8 shrink-0 rounded-lg bg-[#0a0a0a]/40 ring-1 ring-(--sb-accent-fill)/30" />
                  )}
