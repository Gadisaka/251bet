  ...
  return (
    <PageContainer>
      ...
      <div className="relative mx-auto w-full max-w-2xl px-4 pb-28 pt-2 sm:px-5 sm:pt-4">
        <div
          className="pointer-events-none absolute -top-4 left-1/2 h-64 w-[min(100%,36rem)] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(245,197,24,0.12),transparent_68%)] blur-xl"
          aria-hidden
        />
