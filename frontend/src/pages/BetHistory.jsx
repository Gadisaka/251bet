...
const STATUS_STYLES = {
  pending: "bg-(--sb-accent-surface) text-(--sb-accent-fill)",
            ...
            <div className="mt-4 border-t border-white/8 pt-4">
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="rounded-xl bg-(--sb-accent-fill) px-4 py-2 text-xs font-bold text-[#000000] shadow-[0_8px_20px_-8px_rgba(245,197,24,0.45)] transition-all duration-200 hover:scale-[1.02] disabled:opacity-60"
                >
  ...
  return (
    <PageContainer>
      ...
      <div className="relative mx-auto w-full max-w-lg px-4 pb-28 pt-2 sm:px-5 sm:pt-4">
        <div
          className="pointer-events-none absolute -top-4 left-1/2 h-64 w-[min(100%,28rem)] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(245,197,24,0.12),transparent_68%)] blur-xl"
          aria-hidden
        />
          ...
          <div className="flex flex-col items-center justify-center gap-4 py-24 text-[rgba(255,255,255,0.72)]">
            <div className="relative h-14 w-14">
              ...
              <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#111111] ring-2 ring-(--sb-accent-fill)/40">
                <div className="h-7 w-7 animate-spin rounded-full border-2 border-(--sb-accent-fill) border-t-(--sb-accent-fill)" />
              </div>
            </div>
