        ...
        return (
          <div
            ...
            className={`h-2.5 rounded-full transition-all duration-500 ease-out ${
              active
                ? "w-9 bg-(--sb-accent-fill) shadow-[0_0_14px_rgba(245,197,24,0.45)]"
                : done
                  ? "w-2.5 bg-(--sb-accent-fill)/55"
                  : "w-2.5 bg-(--sb-accent-fill)/80"
            }`}
            aria-hidden
          />
        );
    ...
    <PageContainer>
      ...
      <div className="relative mx-auto w-full max-w-lg px-4 pb-28 pt-2 sm:px-5 sm:pt-4">
        ...
        <div className="relative mb-8 flex rounded-full bg-[#0a0a0a]/85 p-1.5 shadow-inner shadow-black/30  backdrop-blur-md">
          <div
            className={`absolute inset-y-1.5 w-[calc(50%-6px)] rounded-full bg-(--sb-accent-fill) shadow-[0_8px_24px_rgba(245,197,24,0.35)] transition-all duration-500 ease-out ${
                      ...
                      return (
                        <button
                          ...
                          className={`group relative flex w-full items-center gap-4 overflow-hidden rounded-2xl px-4 py-3.5 text-left transition-all duration-300 ${
                            sel
                              ? "scale-[1.02] bg-gradient-to-r from-(--sb-accent-surface)/90 via-[#111111] to-[#111111] shadow-[0_12px_32px_-12px_rgba(245,197,24,0.35)] ring-2 ring-(--sb-accent-fill)/70"
